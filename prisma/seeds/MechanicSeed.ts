...
export class MechanicSeed extends Seeder {
	createSeedData(): MechanicData[] {
		return [
			...
			{ ...MechanicSeed.generateTitleWithSlug("Area Majority / Influence") },
			{ ...MechanicSeed.generateTitleWithSlug("Area Movement") },
			{ ...MechanicSeed.generateTitleWithSlug("Auction / Bidding") },
			{ ...MechanicSeed.generateTitleWithSlug("Automatic Resource Growth") },
			{ ...MechanicSeed.generateTitleWithSlug("Betting and Bluffing") },
			{ ...MechanicSeed.generateTitleWithSlug("Bribery") },
			{ ...MechanicSeed.generateTitleWithSlug("Campaign / Battle Card Driven") },
			{ ...MechanicSeed.generateTitleWithSlug("Card Play Conflict Resolution") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Critical Hits and Failures") },
			{ ...MechanicSeed.generateTitleWithSlug("Deck Construction") },
			{ ...MechanicSeed.generateTitleWithSlug("Deck, Bag, and Pool Building") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Different Dice Movement") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Narrative Choice / Paragraph") },
			{ ...MechanicSeed.generateTitleWithSlug("Negotiation") },
			{ ...MechanicSeed.generateTitleWithSlug("Neighbour Scope") },
			{ ...MechanicSeed.generateTitleWithSlug("Network and Route Building") },
			{ ...MechanicSeed.generateTitleWithSlug("Once-Per-Game Abilities") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Point to Point Movement") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Simultaneous Action Selection") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Tech Trees / Tech Tracks") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Turn Order: Claim Action") },
			{ ...MechanicSeed.generateTitleWithSlug("Turn Order: Pass Order") },
			{ ...MechanicSeed.generateTitleWithSlug("Turn Order: Progressive") },
			...
			{ ...MechanicSeed.generateTitleWithSlug("Victory Points as a Resource") },
